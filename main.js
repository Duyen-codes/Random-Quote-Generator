...
fetchQuotesJSON().then(quotes => {
    ...
    function getQuote() {
        ...
        document.querySelector('.newQuoteBtn').backgroundColor = colors[randomColor];
        document.querySelector('.newQuoteBtn').color = 'white';
...
document.querySelector('.quote-box').style.boxShadow = '5px 8px 0 rgba(0, 0, 0, .3)';
